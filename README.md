...
- **Multi-LLM Support**: Supports various AI models via OpenRouter API, direct OpenAI API, Azure OpenAI Service, or custom LLM endpoints
...
1. **Configure Settings**:
   - Go to Settings page
   - Choose provider: OpenRouter, OpenAI, or Custom LLM
   - Enter your API key (OpenRouter or OpenAI)
   - Select your preferred AI model (for OpenRouter)
...
- **Provider**: Choose between OpenRouter, OpenAI, Azure OpenAI, or Custom LLM
- **API Key**: Your API key for OpenRouter, OpenAI, or Azure OpenAI
- **Azure Endpoint**: Your Azure OpenAI resource endpoint (for Azure provider)
